...
export default function Reviews() {
  return (
    <DashboardLayout title="آراء المستأجرين">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-[#001d28] font-black text-2xl mt-2" style={{ fontFamily: C }}>
              تقييمات وآراء المستأجرين ⭐
            </h2>
            <p className="text-gray-500 text-sm leading-relaxed" style={{ fontFamily: F }}>
              نعمل على تطوير منصة متكاملة للتقييمات والتعليقات تتيح للطلاب كتابة تجاربهم الفعلية في السكن، وتساعد ملاك العقارات على تحسين خدماتهم والتفاعل مع الآراء لزيادة الثقة والشفافية.
            </p>
          </div>
          ...
          >
            ...
            <span>سيتم تفعيل هذه الشاشة تلقائياً فور إتاحة ميزة تقييمات السكنات في التحديث القادم للمنصة.</span>
          </div>
        </div>
      </div>
    </DashboardLayout>
